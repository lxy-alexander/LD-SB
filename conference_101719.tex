...
\textbf{Alexander Li} implemented the LD-SB evaluation framework and OrthoP methodology, reproduced the original paper's results across multiple datasets (Tables 1--4, Figures 1--2), contributed to the experimental design, and drafted the paper outline.
