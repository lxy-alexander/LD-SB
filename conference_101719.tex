...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\linewidth]{lazy_rank.png}
\caption{Effective rank evolution in lazy regime.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\linewidth]{results/plot_effective_rank.png}
\caption{Effective rank vs.\ depth (rich regime).}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\linewidth]{results/plot_p_perp_pc.png}
\caption{$P_{\perp}$-pC vs.\ depth.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\linewidth]{results/plot_p_pc.png}
\caption{$P$-pC vs.\ depth.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\linewidth]{results/plot_val_acc.png}
\caption{Validation accuracy vs.\ depth.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.48\linewidth]{results/plot_rank_over_time.png}
